...
import com.ccclubs.ca.bean.OnlinePaceV1;
import com.ccclubs.ca.bean.OnlineStateEventDTO;
import com.ccclubs.ca.bean.StateDTO;
...
public class DemoApp {
    private static Logger logger = Logger.getLogger(DemoApp.class);
...
//        consumerProps.setProperty("bootstrap.servers", propertiesHelper.getValue(BizConstant.ACCEPT_BROKER));
        consumerProps.setProperty("bootstrap.servers", "114.55.239.100:9092");
...
//                        return o1.getCurrentTime().toString() - o2.getCurrentTime().toString();
                ...
                if (latitude != null && longitude != null) {
                    geoHash = GeohashUtil.getGeohashCode(Double.valueOf(latitude.toString()), Double.valueOf(longitude.toString()), 6);
                }
            }
